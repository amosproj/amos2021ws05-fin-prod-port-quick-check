...
import {Button, Link, Flex, List, Table, Thead, Th,  Tr, Td, Tfoot, Tbody, Box, Center, Heading, Text, Stack} from '@chakra-ui/react';
  ...
  return (
      ...
      <Tr>
       <Center>
        ...
        <Link to="../projects">
          <Button size="lg"color="red.900" boxShadow={'2xl'} rounded={'md'} w="100px" bg="red.400" p={3}>REMOVE</Button>
        </Link>
  ...
  return (
    <Center py={6}>
      <Box maxW={'945px'} w={'full'} boxShadow={'2xl'} rounded={'md'} p={6} overflow={'hidden'}>
        <Box h={'20px'} bg={'blue.600'} mt={-6} mx={-6} mb={6} pos={'relative'}>
