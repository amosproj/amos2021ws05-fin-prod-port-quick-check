...
function Login() {
    ...
    return (
        <Flex bg='gray.700' height='100vh' alignItems='center' justify='center'>
            <VStack spacing={4} rounded='lg' w='full' maxW='sm' my='20' p='10'
            bg='gray.100' textColor='gray.800' boxShadow='dark-lg'>
                <Heading color='black'>Sign In</Heading>
                <FormControl id='email' isRequired>
                    <FormLabel>Email</FormLabel>
                    <Input type='email' variant="outline" bg='gray.300' placeholder='E-Mail' _placeholder={{ color: 'gray.500'}}
                        value={email} 
                ...
                <FormControl id='password' isRequired isInvalid={error === 'password'}>
                    ...
                    <Input type='password' variant='outline' bg='gray.300' placeholder='Password' _placeholder={{ color: 'gray.500'}}
                        value={password} 
                ...
                <Button 
                    type='submit' bg='teal.400' onClick={handleSubmit} _hover={{bg: 'teal.300'}} w='20'
                >Login</Button>
